...
def copy():
    ...
    pyperclip.copy(random_passowrd)
...
passwordLabel = Label(root, text='Password Generator', font=('times new roman', 20, 'bold'), bg='pink', fg='black')
...
lengthLabel = Label(root, text='Password Length', font=Font, bg='pink', fg='black')
